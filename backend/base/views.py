...
class ShipmentViewSet(viewsets.ModelViewSet):
    ...
    def update_status(self, request, pk=None):
        ...
        if old_status == 'PENDIENTE' and new_status == 'EN PREPARACION':
            ...
            cc_emails = ["a.delatorre@connectgroup.com", "a.barrientos@connectgroup.com", "e.diaz@connectgroup.com",
                        "cgmg.shipping01@connectgroup.com", "je.robles@connectgroup.com", "a.avelino@connectgroup.com"]
    ...
    def update_add_albaran(self, request, pk=None):
        ...
        to_emails = ["j.perez@connectgroup.com"]
        cc_emails = ["a.delatorre@connectgroup.com", "a.barrientos@connectgroup.com", creator_email, 
                     "d.ibarra@connectgroup.com", "cgmg.shipping01@connectgroup.com",
                     "cgmg.warehouse01@connectgroup.com", "a.avelino@connectgroup.com"]

        html_content = f"""
        <p>Hola Javier Gomez Perez,</p>
